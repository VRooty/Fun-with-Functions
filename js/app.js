...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    ...
    return [sum2, mul2, a + " and " + b + " and " sum to " + sum2 + ".", "The product of " + a + " and " + b + 
    " and " + c + " is " + mul2 + "."]
...
returns an array where the first element is the sum of the numbers in the array, and the second element 
...
sum() function that you've already created. You're going to have to be resourceful to figure out how to 
